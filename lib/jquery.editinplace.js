...
$.fn.editInPlace.defaults = {
	...
	clickEvent:			'click', // string: "click" or "dblclick"; The event that will activate the editor
...
$.extend(InlineEditor.prototype, {
	...
	connectOpeningEvents: function() {
		...
		this.dom
			...
			.bind(this.settings.clickEvent + '.editInPlace', function(anEvent){ that.openEditor(anEvent); });
	},
