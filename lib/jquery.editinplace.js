...
$.fn.editInPlace.defaults = {
	...
	preinit:			null, // function: this function gets called after a click on an editable element but before the editor opens. If you return false, the inline editor will not open. Prototype: function(currentDomNode)
...
$.extend(InlineEditor.prototype, {
	...
	shouldOpenEditor: function(eventTarget) {
		...
		if (this.settings.preinit)
			// REFACT: remove dom node argument
	...
	reportError: function(anErrorString) {
		// REFACT: remove this.id, use $(this).attr('id') instead
