...
$.fn.editInPlace.defaults = {
	...
	preinit:			null, // function: this function gets called after a click on an editable element but before the editor opens. If you return false, the inline editor will not open. Prototype: function(currentDomNode). /* DEPRECATED in 2.1.0 */ Parameter currentDomNode, use $(this) instead.
	postclose:			null // function: this function gets called after the inline editor has closed and all values are updated. Prototype: function(currentDomNode). /* DEPRECATED in 2.1.0 */ Parameter currentDomNode, use $(this) instead.
};
...
$.extend(InlineEditor.prototype, {
	...
	shouldOpenEditor: function(eventTarget) {
		...
		if (this.settings.preinit)
			return false !== this.triggerCallback(this.settings.preinit, /* DEPRECATED in 2.1.0 */ this.dom);
	...
	handleSubmitToCallback: function(enteredText) {
		...
		var newHTML = this.triggerCallback(this.settings.callback, /* DEPRECATED in 2.1.0 */ this.id(), enteredText, this.originalHTML, 
